...
if __name__ == '__main__':
    ...
    for j in range(len(envs)):
        ...
        sitk.WriteImage(state3D_itk, os.path.join(os.getcwd(),'standard_621_L{}_{}.nii.gz'.format(str(j+1), 'left' if screw_index==0 else 'right')))