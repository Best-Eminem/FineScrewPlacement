...
def evaluate(args, env, agent, epoch):
    ...
    while step < args.steps:
        ...
        if done:
            break
    state3D_itk = sitk.GetImageFromArray(np.transpose(max_screw, (2, 1, 0)))
    sitk.WriteImage(state3D_itk, os.path.join(args.imgs_dir ,os.path.basename('spineData/sub-verse621_screw.nii.gz')))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgs_dir', type=str, default='./spinningup/imgs_3d_discrete_volume_2sides_0325')
    parser.add_argument('--snapshot_dir', type=str, default='./spinningup/snapshot_3d_discrete_volume_2sides_0325')
