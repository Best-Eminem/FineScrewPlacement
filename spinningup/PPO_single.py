    ...
    for dataDir, pedicle_point in zip(dataDirs, pedicle_points):
        ...
        while step < args.steps:
            ...
            with torch.no_grad():
                ...
                rew_buf, L_grad = buf.rew_buf.copy(), buf.L_grad.copy()
            ...
            # if index == 5 and 3.14*env.state_matrix[2]*env.state_matrix[0]*env.state_matrix[0] > 4600:
            #     break
        state3D_itk = sitk.GetImageFromArray(np.transpose(env.state3D_array, (2, 1, 0)))
